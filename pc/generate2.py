...
data = "UKBB"
split = "8020"
snps = f"ukbb_{split}_chr{chrnum}_21538"
latents = 128
ps = 0.005
num_epochs = 2000
...
for i in tqdm(range(100), desc="Sampling 100s"):
...
# Save
np.savetxt(f'/scratch2/prateek/genetic_pc_github/results/{data}/{split}/hclt/{data}_hclt_chr{chrnum}_{split}_samples.txt', d, fmt='%d')